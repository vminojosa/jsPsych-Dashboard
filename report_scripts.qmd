...
def fetch_api(endpoint):
  ...
  headers = {'Authorization': f'token $API_AUTH'}
  final_data=[]
  while url:
...
iss_df  = select_ent('issues')
pull_df = select_ent('pulls')
comm_df = create_comm_dataframe()
my_issues_analysis, my_prs_analysis, my_issues_quarterly, my_prs_quarterly = generate_report()
```

Declaring Variables for Report Pages
